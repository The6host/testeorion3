const COLUMNS = [
  {
    title: 'PRODUTO',
    links: ['Recursos', 'Como funciona', 'Preços'],
  },
  {
    title: 'EMPRESA',
    links: ['Sobre nós', 'Blog', 'Contato'],
  },
  {
    title: 'SUPORTE',
    links: ['Central de ajuda', 'Termos', 'Privacidade'],
  },
]
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
            ...
            <div className="flex gap-3 flex-wrap">
              {SOCIALS.map(({ label, icon: Icon }) => (
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="flex items-center justify-center w-9 h-9 rounded-full text-white/50 hover:text-white transition-colors duration-200"
                  style={{
        ...
        <div className="border-t border-white/10 pt-6 text-center">
          <p className="text-xs text-white/30">
            © 2024 ORION. Todos os direitos reservados.
          </p>
        </div>
