...
import { ArrowLeft, Sun, Star, Clock, ChevronRight } from 'lucide-react'
...
const ROUTINE_PATHS = {
  'Hidratação Corporal Completa':    '/modulos/aparencia/corporais/hidratacao',
  'Esfoliação Corporal Renovadora':  '/modulos/aparencia/corporais/esfoliacao',
  'Cuidado Capilar Intensivo':       '/modulos/aparencia/corporais/capilar',
}
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 8, marginBottom: 10 }}>
        ...
        <div style={{
          fontSize: 13, fontWeight: 900, color: ORANGE, flexShrink: 0,
      ...
      <div style={{ borderTop: '1px solid #1e1e1e', paddingTop: 12, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <motion.button
          ...
          style={{
            ...
            background: '#1a0a00', color: ORANGE,
...
export default function CorporaisList() {
  ...
  useEffect(() => {
    fetchRoutinesByModule('corporais').then(async data => {
      ...
      <div style={{ maxWidth: 520, margin: '0 auto', padding: '24px 16px 88px' }}>
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: 16, fontWeight: 900, color: '#fff', lineHeight: 1.2 }}>Cuidados Corporais</div>
            <div style={{ fontSize: 11, color: MUTED, marginTop: 2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              Rotinas de cuidados para o corpo
            </div>
          </div>
          <button
