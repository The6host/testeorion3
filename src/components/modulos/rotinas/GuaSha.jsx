...
const DATA = {
  ...
  levelColor: '#F59E0B',
  levelBg: '#1a1200',
  levelBorder: '#F59E0B33',
  benefits: ['Drenagem linfática', 'Reduz inchaço', 'Define contorno facial', 'Aumenta circulação', 'Relaxamento muscular'],
  steps: [
    'Aplique óleo facial ou sérum para deslizamento',
    'Comece pelo pescoço, movimentos ascendentes',
    'Deslize da linha da mandíbula até a orelha (5x cada lado)',
    'Do queixo até o topo da bochecha (5x cada lado)',
    'Sob os olhos, da ponte do nariz até a têmpora (3x cada lado)',
    'Testa: do centro até as laterais (5x)',
    'Finalize com movimentos suaves no pescoço',
  ],
}

export default function GuaSha() {
