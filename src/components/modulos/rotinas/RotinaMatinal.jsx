...
const DATA = {
  ...
  benefits: ['Proteção solar', 'Hidratação profunda', 'Prepara pele para maquiagem', 'Antioxidantes', 'Viço e luminosidade'],
  steps: [
    'Lave o rosto com água morna',
    'Aplique cleanser suave com movimentos circulares',
    'Enxágue completamente',
    'Seque com toalha limpa (sem esfregar)',
    'Aplique tônico com algodão ou mãos',
    'Sérum de vitamina C (aguarde 1 min)',
    'Creme para área dos olhos',
    'Hidratante facial',
    'Protetor solar FPS 30+ (último passo obrigatório)',
  ],
}

export default function RotinaMatinal() {
