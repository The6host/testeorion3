...
import { ArrowLeft, Sun, Star, Clock, CheckCircle2 } from 'lucide-react'
import BottomNav from '../../BottomNav'
import { fetchRoutinesByModule, fetchRoutineSteps, completeRoutine } from '../../../lib/userData'
import { useUserDataContext } from '../../../context/UserDataContext'

const ROUTINE_NAME = 'Esfoliação Corporal Renovadora'
...
export default function EsfoliacaoCorporal() {
  ...
  useEffect(() => {
    fetchRoutinesByModule('corporais').then(routines => {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#080808', color: '#fff' }}>
      <div style={{ maxWidth: 520, margin: '0 auto', padding: '24px 16px 88px' }}>
        ...
        >
          <button onClick={() => navigate('/modulos/aparencia/corporais')} style={BTN_ICON}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 14 }}>
            ...
            <span style={{
              fontSize: 13, fontWeight: 900, color: ORANGE,
