...
const DATA = {
  ...
  benefits: ['Lifting natural', 'Tonificação muscular', 'Melhora textura da pele', 'Reduz linhas de expressão', 'Efeito rejuvenescedor'],
  steps: [
    'Limpe as mãos e aplique creme facial',
    'Aquecimento: movimentos circulares suaves no rosto todo (2 min)',
    'Testa: pressione com os dedos do centro às laterais (1 min)',
    'Contorno dos olhos: toque delicado em círculos (1 min)',
    'Bochechas: movimentos ascendentes firmes (2 min)',
    'Mandíbula: deslize do queixo até orelhas com pressão (2 min)',
    'Nariz e maxilar: pressão com os dedos (1 min)',
    'Pescoço: movimentos de baixo para cima (2 min)',
    'Finalização: toque suave em todo o rosto (2 min)',
  ],
}
