...
const DATA = {
  ...
  benefits: ['Regeneração celular', 'Combate sinais de idade', 'Reparação noturna', 'Hidratação intensa', 'Renovação da pele'],
  steps: [
    'Remova toda maquiagem com óleo demaquilante',
    'Lave com cleanser específico para seu tipo de pele',
    'Dupla limpeza: repita a lavagem',
    'Esfoliação suave (2-3x por semana apenas)',
    'Aplique tônico equilibrante',
    'Sérum de ácido hialurônico ou retinol',
    'Creme para área dos olhos',
    'Hidratante noturno mais denso',
    'Óleo facial (opcional, peles secas)',
  ],
}
